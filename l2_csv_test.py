...
class TestCSVClass(unittest.TestCase):
  ...
  def testFillBlanksWithMidclass (self):
    table = CSVTable('l2_csv_test_2.txt', 1)
    table.fillblanks('midclass', None)
    self.assertEqual(table.records[0][0], 0)
    self.assertEqual(table.records[0][1], 1)
    self.assertEqual(table.records[0][2], 2)
    self.assertEqual(table.records[0][3], 3)
  ...
  def testNormalizeMaxmin (self):
    table = CSVTable('l2_csv_test_2.txt', 1)
    table.normalize('maxmin')
    self.assertEqual(table.records[0][0], 0)
    self.assertEqual(table.records[0][1], 0.3333333333333333)
    self.assertEqual(table.records[0][2], 0.6666666666666666)
    self.assertEqual(table.records[0][3], 1.0)
    self.assertEqual(table.records[1][0], 0)
    self.assertEqual(table.records[1][1], '')
    self.assertEqual(table.records[1][2], 0.3333333333333333)
    self.assertEqual(table.records[1][3], 1.0)
    self.assertEqual(table.records[2][0], 0.0)
    self.assertEqual(table.records[2][1], 0.0)
